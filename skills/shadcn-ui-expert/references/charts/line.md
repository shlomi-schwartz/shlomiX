...
- **Docs**: https://ui.shadcn.com/charts#line-chart

## Variants

> **10 variants available.** Ask the user which variant they need before providing code.

- **Default** (`chart-line-default`)
- **Linear** (`chart-line-linear`)
- **Step** (`chart-line-step`)
- **Multiple** (`chart-line-multiple`)
- **Dots** (`chart-line-dots`)
- **Custom Dots** (`chart-line-dots-custom`)
- **Dots Colors** (`chart-line-dots-colors`)
- **Label** (`chart-line-label`)
- **Custom Label** (`chart-line-label-custom`)
- **Interactive** (`chart-line-interactive`)
