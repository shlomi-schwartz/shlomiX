...
- **Docs**: https://ui.shadcn.com/charts#radial-chart

## Variants

> **6 variants available.** Ask the user which variant they need before providing code.

- **Simple** (`chart-radial-simple`)
- **Label** (`chart-radial-label`)
- **Grid** (`chart-radial-grid`)
- **Text** (`chart-radial-text`)
- **Shape** (`chart-radial-shape`)
- **Stacked** (`chart-radial-stacked`)
