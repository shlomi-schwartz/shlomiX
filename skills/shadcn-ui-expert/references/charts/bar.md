...
- **Docs**: https://ui.shadcn.com/charts#bar-chart

## Variants

> **10 variants available.** Ask the user which variant they need before providing code.

- **Default** (`chart-bar-default`)
- **Horizontal** (`chart-bar-horizontal`)
- **Multiple** (`chart-bar-multiple`)
- **Stacked** (`chart-bar-stacked`)
- **Label** (`chart-bar-label`)
- **Custom Label** (`chart-bar-label-custom`)
- **Mixed** (`chart-bar-mixed`)
- **Active** (`chart-bar-active`)
- **Negative** (`chart-bar-negative`)
- **Interactive** (`chart-bar-interactive`)
