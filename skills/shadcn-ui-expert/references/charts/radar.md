...
- **Docs**: https://ui.shadcn.com/charts#radar-chart

## Variants

> **14 variants available.** Ask the user which variant they need before providing code.

- **Default** (`chart-radar-default`)
- **Dots** (`chart-radar-dots`)
- **Multiple** (`chart-radar-multiple`)
- **Lines Only** (`chart-radar-lines-only`)
- **Legend** (`chart-radar-legend`)
- **Icons** (`chart-radar-icons`)
- **Custom Label** (`chart-radar-label-custom`)
- **Radius Axis** (`chart-radar-radius`)
- **Grid Circle** (`chart-radar-grid-circle`)
- **Grid Circle Filled** (`chart-radar-grid-circle-fill`)
- **Grid Circle No Lines** (`chart-radar-grid-circle-no-lines`)
- **Grid Fill** (`chart-radar-grid-fill`)
- **Grid None** (`chart-radar-grid-none`)
- **Grid Custom** (`chart-radar-grid-custom`)
