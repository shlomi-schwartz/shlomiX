...
- **Docs**: https://ui.shadcn.com/charts#pie-chart

## Variants

> **11 variants available.** Ask the user which variant they need before providing code.

- **Simple** (`chart-pie-simple`)
- **Label** (`chart-pie-label`)
- **Custom Label** (`chart-pie-label-custom`)
- **Label List** (`chart-pie-label-list`)
- **Legend** (`chart-pie-legend`)
- **Donut** (`chart-pie-donut`)
- **Donut Active** (`chart-pie-donut-active`)
- **Donut with Text** (`chart-pie-donut-text`)
- **Stacked** (`chart-pie-stacked`)
- **No Separator** (`chart-pie-separator-none`)
- **Interactive** (`chart-pie-interactive`)
